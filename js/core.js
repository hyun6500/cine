...
const CONFIG = {
  ...
  APPS_SCRIPT_URL: "",       // ② Apps Script 웹앱 URL — TMDB 프록시 + 기록 추가 겸용
...
const S = {
  ...
  wall:    { cat:null, med:null, genre:null, nflx:null, sort:"recent", shown:0, data:[] },
  diary:   { shown:0 },
  explore: { axis:"genre", group:null },
  dirty:   { browse:true, dash:true, wall:true, diary:true, explore:true, add:true },
};
